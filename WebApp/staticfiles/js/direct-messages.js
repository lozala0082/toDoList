/**
 * Direct message handling implementation - no modules, no imports, just plain JavaScript
 * This script will handle displaying Django messages in a snackbar
 */
window.addEventListener('DOMContentLoaded', function() {
  console.log('Direct messages script loaded');
